...
def create_code() -> str:
	"""
	Generate a verification code for the user to provide at https://scratch.mit.edu/projects/802930818. This is just a convenience method - you can use any numerical code.
